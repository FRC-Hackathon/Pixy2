...
T_pixy2ErrorCode PIXY2::pixy2_sndGetLineFeature (Byte type, Byte feature){
    T_pixy2SendBuffer   msg;
    int                 i = 0, dataSize = 2;
    msg.frame.header.pixSync = PIXY2_SYNC;
...
T_pixy2ErrorCode PIXY2::pixy2_sndSetNextTurn (Word angle){
    T_pixy2SendBuffer   msg;
    int                 i = 0, dataSize = 2;
    T_Word              tmp;
    tmp.mot = angle;
...
T_pixy2ErrorCode PIXY2::pixy2_getVersion (T_pixy2Version **ptrVersion){
...
T_pixy2ErrorCode PIXY2::pixy2_getResolution (T_pixy2Resolution **ptrResolution){
...
T_pixy2ErrorCode PIXY2::pixy2_getFeatures (){
...
T_pixy2ErrorCode PIXY2::pixy2_getMainFeature (Byte features){
...
T_pixy2ErrorCode PIXY2::pixy2_getAllFeature (Byte features){
    T_pixy2ErrorCode    cr = PIXY2_OK;
...
T_pixy2ErrorCode PIXY2::pixy2_setNextTurn (sWord angle)
{
    T_pixy2RcvHeader    *msg = (T_pixy2RcvHeader*) &Pixy2_buffer[hPointer];
    T_pixy2ErrorCode    cr = PIXY2_OK;
...
T_pixy2ErrorCode PIXY2::pixy2_setDefaultTurn (sWord angle)
{
    T_pixy2RcvHeader    *msg = (T_pixy2RcvHeader*) &Pixy2_buffer[hPointer];
    T_pixy2ErrorCode    cr = PIXY2_OK;
...
T_pixy2ErrorCode PIXY2::pixy2_setVector (Byte vectorIndex)
{
    T_pixy2RcvHeader    *msg = (T_pixy2RcvHeader*) &Pixy2_buffer[hPointer];
    T_pixy2ErrorCode    cr = PIXY2_OK;
...
T_pixy2ErrorCode PIXY2::pixy2_ReverseVector (void)
{
    T_pixy2RcvHeader    *msg = (T_pixy2RcvHeader*) &Pixy2_buffer[hPointer];
    T_pixy2ErrorCode    cr = PIXY2_OK;
